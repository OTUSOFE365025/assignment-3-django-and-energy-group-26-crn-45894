...
# Ensure sample products are present so the TA can scan them via the web UI
...
# Always ensure the demo short codes exist (update or create so it is idempotent)
